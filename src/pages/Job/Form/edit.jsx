...
const EditJob = () => {
  ...
  const getJob = () => {
    axios.get(`https://kaied-employee-panel-api.onrender.com/job/${id}`).then(reponse => {
      setJob(reponse.data)
   })
 }
  ...
  useEffect(() => {
    ...
    const { values , errors, handleSubmit, handleChange } = useFormik({
      ...
      onSubmit : async(values) => {
          ...
          await axios.patch(`https://kaied-employee-panel-api.onrender.com/job/${id}`, data, 
