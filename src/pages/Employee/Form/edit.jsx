...
const EditEmployee = () => {
    ...
    const getEmployee = () => {
      axios.get(`https://kaied-employee-panel-api.onrender.com/employee/${id}`).then(response => {
    ...
    const { values , errors, handleSubmit, handleChange, setFieldValue } = useFormik({
      ...
      onSubmit : async(values) => {
          ...
          await axios.patch(`https://kaied-employee-panel-api.onrender.com/employee/${id}`, data, 
