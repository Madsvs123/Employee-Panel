    ...
    <Box sx={{ display: 'flex' }}>
      <StyledAppBar position="fixed" open={open}>
        <Toolbar sx={{display: 'flex', justifyContent: 'space-between', alignItems: 'center'}}>
          ...
          <Typography variant="h6" display="flex" alignItems="center" noWrap component="div">
      ...
      <StyledDrawer variant="permanent" open={open} PaperProps={{sx : {backgroundColor : theme.palette.primary.dark, color : "#FFF"}}}>
        <DrawerHeader>
        <Box display="flex" alignItems="center" justifyContent="center" ml="1rem">
          ...
          <IconButton color='primary' onClick={handleDrawerClose}>
            {theme.direction === 'rtl' ? <ChevronRight sx={{color : "#FFF"}} /> : <ChevronLeft sx={{color : "#FFF"}} />}
          </IconButton>
        </DrawerHeader>
        <Divider />
        <List>
